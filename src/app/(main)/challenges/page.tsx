    ...
    <div className="max-w-2xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <Link
            href="/challenges/new"
            className="mt-5 inline-flex items-center gap-1.5 rounded-xl bg-primary px-5 py-2.5 text-sm font-medium text-white shadow-sm"
          >
            <Plus size={16} />
            チャレンジを作成
          </Link>
        ...
        <div className="space-y-3">
          {challenges.map(c => {
            ...
            return (
              <div
                key={c.id}
                className="rounded-xl border border-border bg-white p-5 transition-all hover:shadow-md hover:shadow-gray-200/50"
              >
